...
- [Spotify sync architecture](spotify-sync-architecture.md) — write endpoints use api_client.dart (Firebase token); server resolves UID from token; sync validates listenerUid is in couple
